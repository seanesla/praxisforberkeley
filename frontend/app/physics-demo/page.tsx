...
export default function PhysicsDemo() {
  useEffect(() => {
    const init = async () => {
      ...
      const indices = new Uint32Array((torusKnotMesh.geometry.index as THREE.BufferAttribute).array);
      ...
      return () => {
        ...
        renderer.domElement.removeEventListener('click', handleResize);
